...
class AlbumView extends GetView<AlbumLogic> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(Lang.album, style: TextStyle(fontSize: ScreenUtil().setSp(18), fontWeight: FontWeight.w600)),
        elevation: 0,
      ),
      body: Obx(() {
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                ...
                onLongPress: () => controller.showDeleteConfirm(index),
                child: path != null
                    ? ClipRRect(
